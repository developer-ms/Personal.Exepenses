...
namespace Personal.Expenses.Api.Controllers
{
    ...
    public class UplaodController : Controller
    {
        ...
        public UplaodController(ILoggerFactory logger, IHostingEnvironment env, IOptions<ConfigSettingsBase> configSettingsBase, IStorage storage)
        {
        ...
        public async Task<IActionResult> Post(ICollection<IFormFile> files, string folder, bool rename = true)
        {
            ...
            {
                var responseEx = result.ReturnCustomException(ex, " Personal.Expenses - Upload");
				return responseEx;
