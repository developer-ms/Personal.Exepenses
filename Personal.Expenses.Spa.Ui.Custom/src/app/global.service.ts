...
export class AuthSettings {
  ...
  constructor() {
    ...
    this.CLIENT_ID = 'Personal.Expenses-spa-custom';
    this.CLIENT_ID_RO = 'Personal.Expenses-spa-custom';
    this.CLIENT_ID_CC = 'Personal.Expenses-spa-custom';
    this.CLIENT_ID_CC = "Personal.Expenses-spa-anonymous";
